...
import 'package:maze_app/data_provider/refresh_token/token_manager.dart'
    as _i52;
import 'package:maze_app/di/injection_container.dart' as _i53;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i31.ForgotPassBloc>(
        () => _i31.ForgotPassBloc(gh<_i25.ForgotPassRepository>()));
    gh.factory<_i32.LoginRepository>(
        () => _i33.LoginRepositoryImpl(gh<_i18.LoginRemoteDataSource>()));
    gh.factory<_i34.VerifyRepository>(
        () => _i35.VerifyRepositoryImpl(gh<_i22.VerifyRemoteDataSource>()));
    gh.factory<_i36.TokenRemoteDataSource>(() => _i36.TokenRemoteDataSourceImpl(
        gh<_i17.DioCaller>(instanceName: 'maze')));
    gh.factory<_i37.VerifyBloc>(
        () => _i37.VerifyBloc(gh<_i34.VerifyRepository>()));
    gh.factory<_i38.GetIsFirstRun>(
        () => _i38.GetIsFirstRun(repo: gh<_i27.IntroRepo>()));
    gh.factory<_i39.SetIsFirstRun>(
        () => _i39.SetIsFirstRun(repo: gh<_i27.IntroRepo>()));
    gh.factory<_i40.SignupRemoteDataSource>(() =>
        _i41.SignupRemoteDataSourceImpl(
            dioCaller: gh<_i17.DioCaller>(instanceName: 'maze')));
    gh.factory<_i42.TokenRepository>(
        () => _i43.TokenRepositoryImpl(gh<_i36.TokenRemoteDataSource>()));
    gh.factory<_i44.CreatePasswordRepository>(() =>
        _i45.CreatePasswordRepositoryImpl(
            gh<_i29.CreatePasswordRemoteDataSource>()));
    gh.factory<_i46.LoginBloc>(
        () => _i46.LoginBloc(gh<_i32.LoginRepository>()));
    gh.factory<_i47.CreatePassBloc>(
        () => _i47.CreatePassBloc(gh<_i44.CreatePasswordRepository>()));
    gh.factory<_i48.IntroCubit>(() => _i48.IntroCubit(
          getIsFirstRun: gh<_i38.GetIsFirstRun>(),
          setIsFirstRun: gh<_i39.SetIsFirstRun>(),
          router: gh<_i6.AppRouter>(),
        ));
    gh.factory<_i49.SignupRepository>(
        () => _i50.SignupRepositoryImpl(gh<_i40.SignupRemoteDataSource>()));
    gh.factory<_i51.SignupBloc>(
        () => _i51.SignupBloc(gh<_i49.SignupRepository>()));
    gh.factory<_i52.TokenManager>(() => _i52.TokenManager(
          gh<_i13.SettingsManager>(),
          gh<_i42.TokenRepository>(),
          gh<_i11.AppLog>(),
        ));
    return this;
  }
