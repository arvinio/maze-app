...
abstract class NetworkModule {
  ...
  Dio provideBaseDio(PrettyDioLogger prettyDioLogger) => provideDio(
    baseUrl: 'http://maze.ap-southeast-2.elasticbeanstalk.com/',
  );
  ...
  @Named(DiConst.dioNamedMaze)
  @lazySingleton
  DioCaller provideBaseDioCaller(@Named(DiConst.dioNamedMaze) Dio dio) => DioCaller(dio: dio);



  @Named(DiConst.dioNamedToken)
  @lazySingleton
  DioCaller provideTokenDioCaller(@Named(DiConst.dioNamedToken) Dio dio) => DioCaller(dio: dio);
}
