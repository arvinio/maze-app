    ...
    final theme = ThemeData(
      ...
      inputDecorationTheme: defaultTheme.inputDecorationTheme.copyWith(
        border: OutlineInputBorder(
            ...
            borderRadius:
                const BorderRadius.all(Radius.circular(Dimen.inputRadius))),
        ...
        errorStyle:
            context.captionCaption.copyWith(color: appColors.error.light),
        errorMaxLines: 2,
...
extension TextThemeSchemeExtension on BuildContext {
  TextStyle get titleLargeTitle => TextStyle(
      color: Theme.of(this).colorScheme.primaryText,
      fontWeight: FontWeight.w700,
      fontSize: 34);

  TextStyle get titleTitle1 => TextStyle(
      color: Theme.of(this).colorScheme.primaryText,
      fontWeight: FontWeight.w700,
      fontSize: 28);

  TextStyle get titleTitle2 => TextStyle(
      color: Theme.of(this).colorScheme.primaryText,
      fontWeight: FontWeight.w700,
      fontSize: 22);

  TextStyle get titleTitle3 => TextStyle(
      color: Theme.of(this).colorScheme.primaryText,
      fontWeight: FontWeight.w700,
      fontSize: 20);

  TextStyle get titleHeadline => TextStyle(
      color: Theme.of(this).colorScheme.primaryText,
      fontWeight: FontWeight.w600,
      fontSize: 17);

  TextStyle get bodyBodyMedium => TextStyle(
      color: Theme.of(this).colorScheme.primaryText,
      fontWeight: FontWeight.w500,
      fontSize: 17);

  TextStyle get bodyBody => TextStyle(
      color: Theme.of(this).colorScheme.primaryText,
      fontWeight: FontWeight.w400,
      fontSize: 17);

  TextStyle get bodyCallout => TextStyle(
      color: Theme.of(this).colorScheme.primaryText,
      fontWeight: FontWeight.w400,
      fontSize: 16);

  TextStyle get subheadlineSubheadlineMedium => TextStyle(
      color: Theme.of(this).colorScheme.primaryText,
      fontWeight: FontWeight.w500,
      fontSize: 15);

  TextStyle get subheadlineSubheadline => TextStyle(
      color: Theme.of(this).colorScheme.primaryText,
      fontWeight: FontWeight.w400,
      fontSize: 15);

  TextStyle get subheadlineSubheadlineSemibold => TextStyle(
      color: Theme.of(this).colorScheme.primaryText,
      fontWeight: FontWeight.w600,
      fontSize: 15);

  TextStyle get footnoteFootnoteBold => TextStyle(
      color: Theme.of(this).colorScheme.primaryText,
      fontWeight: FontWeight.w600,
      fontSize: 13);

  TextStyle get footnoteFootnote => TextStyle(
      color: Theme.of(this).colorScheme.primaryText,
      fontWeight: FontWeight.w400,
      fontSize: 13);

  TextStyle get captionCaptionSemibold => TextStyle(
      color: Theme.of(this).colorScheme.primaryText,
      fontWeight: FontWeight.w600,
      fontSize: 11);

  TextStyle get captionCaption => TextStyle(
      color: Theme.of(this).colorScheme.primaryText,
      fontWeight: FontWeight.w400,
      fontSize: 11);

  TextStyle get otherNavigationLabel => TextStyle(
      color: Theme.of(this).colorScheme.primaryText,
      fontWeight: FontWeight.w400,
      fontSize: 10,
      letterSpacing: -0.24);
...
extension ColorSchemeExtension on ColorScheme {
  ...
  Color get primariesShade01 => brightness == Brightness.light
      ? appColors.primariesShade01.light
      : appColors.primariesShade01.dark;

  Color get primariesShade02 => brightness == Brightness.light
      ? appColors.primariesShade02.light
      : appColors.primariesShade02.dark;

  Color get primariesShade03 => brightness == Brightness.light
      ? appColors.primariesShade03.light
      : appColors.primariesShade03.dark;

  Color get primaryText => brightness == Brightness.light
      ? appColors.primaryText.light
      : appColors.primaryText.dark;

  Color get secondaryText => brightness == Brightness.light
      ? appColors.secondaryText.light
      : appColors.secondaryText.dark;

  Color get tertiaryText => brightness == Brightness.light
      ? appColors.tertiaryText.light
      : appColors.tertiaryText.dark;

  Color get disabledText => brightness == Brightness.light
      ? appColors.disabledText.light
      : appColors.disabledText.dark;

  Color get whiteText => brightness == Brightness.light
      ? appColors.whiteText.light
      : appColors.whiteText.dark;

  Color get neutralsBackground => brightness == Brightness.light
      ? appColors.neutralsBackground.light
      : appColors.neutralsBackground.dark;

  Color get neutralsCards => brightness == Brightness.light
      ? appColors.neutralsCards.light
      : appColors.neutralsCards.dark;

  Color get neutralsFieldsTags => brightness == Brightness.light
      ? appColors.neutralsFieldsTags.light
      : appColors.neutralsFieldsTags.dark;

  Color get neutralsBorderDivider => brightness == Brightness.light
      ? appColors.neutralsBorderDivider.light.withOpacity(0.08)
      : appColors.neutralsBorderDivider.dark.withOpacity(0.08);
  ...
  Color get success => brightness == Brightness.light
      ? appColors.success.light
      : appColors.success.dark;

  Color get warning => brightness == Brightness.light
      ? appColors.warning.light
      : appColors.warning.dark;

  Color get info => brightness == Brightness.light
      ? appColors.info.light
      : appColors.info.dark;
  ...
  Color get disableButtonBackground => brightness == Brightness.light
      ? appColors.disabledText.light
      : appColors.disabledText.dark;
  ...
  Color get expandMoreDropDown => brightness == Brightness.light
      ? appColors.expandMoreDropDown.light
      : appColors.expandMoreDropDown.dark;

  Color get selectIconDropDown => brightness == Brightness.light
