...
import 'package:maze_app/feature/knowledge/presentation/view/article_page.dart';
import 'package:maze_app/feature/knowledge/presentation/view/bookmarks_page.dart';
...
class AppRouter extends _$AppRouter {
  ...
  final List<AutoRoute> routes = [
    ...
    AutoRoute(path: '/', page: BottomNavigationRoute.page),
    AutoRoute(
    ...
    AutoRoute(path: '/HomePage', page: KnowledgePageRoute.page),
  ];
}
