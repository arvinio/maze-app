...
CommunityPostResponse communityLeaderboardResponseFromJson(String str) => CommunityPostResponse.fromJson(json.decode(str));
...
class CommunityPostResponse with _$CommunityPostResponse{
  ...
  factory CommunityPostResponse.fromJson(Map<String, dynamic> json) => _$CommunityPostResponseFromJson(json);
