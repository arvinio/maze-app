...
class CouncilBinDialogContent extends StatefulWidget  {
  const CouncilBinDialogContent({super.key});

  @override
  State<CouncilBinDialogContent> createState() => _CouncilBinDialogContentState();
}

class _CouncilBinDialogContentState extends State<CouncilBinDialogContent> {
  @override
  void initState() {
    super.initState();
  }
                                                ...
                                                Column(
                                                  mainAxisAlignment: MainAxisAlignment.center,
                                                    ...
                                                    CrossAxisAlignment
                                                        .start, children: [
                                                  CustomText(
                                                      measurementSystem[index].toString()!),
