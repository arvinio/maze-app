...
class AccountInfoRemoteRemoteDataSourceImpl implements AccountInfoRemoteRemoteDataSource {
  ...
  AccountInfoRemoteRemoteDataSourceImpl({@Named(DiConst.dioNamedToken)  required this.dioCaller});



  @override
  Future<ApiResponse> getCountryList() async{
    return await dioCaller.get('api/country', fromJson: AccountInfoResponse.fromJson);

    }

  @override
  Future<ApiResponse> getSateList({required String countryId}) async{
    return await dioCaller.get('api/state?countryId=$countryId', fromJson: AccountInfoResponse.fromJson);
  ...
  Future<ApiResponse> getCouncilList({required String stateId}) async{
    return await dioCaller.get('api/council?stateId=$stateId', fromJson: AccountInfoResponse.fromJson);

  }

  @override
  Future<ApiResponse<RegisterDetailsResponse>> registerDetails({required UserInfo userInfoParam}) async{
    return await dioCaller.post<RegisterDetailsResponse>('api/user/details', fromJson: RegisterDetailsResponse.fromJson,
        data: {
          'firstName': userInfoParam.firstName,
          'avatar': userInfoParam.avatar,
